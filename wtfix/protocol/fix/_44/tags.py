...
from wtfix.protocol.tags import _BaseTag
...
class Tag(_BaseTag):
    ...
    Price = 44
    RefSeqNum = 45
    # RelatdSym = 46 (no longer used)
    # Rule80A = 47 (no longer used)
    SecurityID = 48
    SenderCompID = 49
    SenderSubID = 50
    ...
    OrdRejReason = 103
    IOIQualifier = 104
    # WaveNo = 105 (no longer used)
    Issuer = 106
    SecurityDesc = 107
    HeartBtInt = 108
    # ClientID = 109 (replaced)
    MinQty = 110
    MaxFloor = 111
    TestReqID = 112
    ReportToExch = 113
    ...
    # SettlDepositoryCode = 173 (replaced)
    # SettlBrkrCode = 174 (replaced)
    # SettlInstCode = 175 (replaced)
    # SecuritySettlAgentName = 176 (replaced)
    # SecuritySettlAgentCode = 177 (replaced)
    # SecuritySettlAgentAcctNum = 178 (replaced)
    # SecuritySettlAgentAcctName = 179 (replaced)
    # SecuritySettlAgentContactName = 180 (replaced)
    # SecuritySettlAgentContactPhone = 181 (replaced)
    # CashSettlAgentName = 182 (replaced)
    # CashSettlAgentCode = 183 (replaced)
    # CashSettlAgentAcctNum = 184 (replaced)
    # CashSettlAgentAcctName = 185 (replaced)
    # CashSettlAgentContactName = 186 (replaced)
    # CashSettlAgentContactPhone = 187 (replaced)
    BidSpotRate = 188
    ...
    IssueDate = 225
    # RepurchaseTerm = 226 (deprecated)
    # RepurchaseRate = 227 (deprecated)
    Factor = 228
    ...
    TotalTakedown = 237
    Concession = 238
    # RepoCollateralSecurityType = 239 (deprecated)
    # RedemptionDate = 240 (deprecated)
    UnderlyingCouponPaymentDate = 241
    UnderlyingIssueDate = 242
    # UnderlyingRepoCollateralSecurityType = 243 (deprecated)
    # UnderlyingRepurchaseTerm = 244 (deprecated)
    # UnderlyingRepurchaseRate = 245 (deprecated)
    UnderlyingFactor = 246
    # UnderlyingRedemptionDate = 247 (deprecated)
    LegCouponPaymentDate = 248
    LegIssueDate = 249
    # LegRepoCollateralSecurityType = 250 (deprecated)
    # LegRepurchaseTerm = 251 (deprecated)
    # LegRepurchaseRate = 252 (deprecated)
    LegFactor = 253
    # LegRedemptionDate = 254 (deprecated)
    CreditRating = 255
    ...
    # UnderlyingMaturityDay = 314 (replaced)
    # UnderlyingStrikePrice = 316 (replaced)
    UnderlyingOptAttribute = 317
    UnderlyingCurrency = 318
    # RatioQty = 319 (replaced)
    SecurityReqID = 320
    ...
    # OnBehalfOfSendingTime = 370 (no longer used)
    RefTagID = 371
    RefMsgType = 372
    ...
    ContraTradeQty = 437
    ContraTradeTime = 438
    # ClearingFirm = 439 (replaced)
    # ClearingAccount = 440 (replaced)
    ...
    PartyIDSource = 447
    PartyID = 448
    # TotalVolumeTradedDate = 449 (replaced)
    # TotalVolumeTradedTime = 450 (replaced)
    NetChgPrevDay = 451
    PartyRole = 452
    NoPartyIDs = 453
    NoSecurityAltID = 454
    ...
    # TotalAccruedInterestAmt = 540 (deprecated)
    MaturityDate = 541
